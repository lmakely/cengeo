...
swimdir = r'\\batch4.ditd.census.gov\mtdata003_geoarea\BAS\Digital_BAS_2017\Local_Submission'
...
def runit(basid, supervised=True):
    ...
    try:
        ...
        #counties = getCounties(list(x+'\\'+y for x,y in changeFiles), BAS17countyMerge)
